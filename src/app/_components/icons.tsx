...
export function ToolIcon({ className, color }: IconProps) {
  return (
    <SvgComponent
      color={color}
      className={className}
...
export function ShieldIcon({ className, color }: IconProps) {
  return (
    <SvgComponent
      color={color}
      className={className}
...
export function StarsIcon({ className, color }: IconProps) {
  return (
    <SvgComponent
      color={color}
      className={className}
...
export function SearchFolderIcon({ className, color }: IconProps) {
  return (
    <SvgComponent
      color={color}
      className={className}
...
export function PeopleIcon({ className, color }: IconProps) {
  return (
    <SvgComponent
      color={color}
      className={className}
...
export function HouseIcon({ className, color }: IconProps) {
  return (
    <SvgComponent
      color={color}
      className={className}
...
export function ModernHouseIcon({ className, color }: IconProps) {
  return (
    <SvgComponent
      color={color}
      className={className}
...
export function BuildingIcon({ className, color }: IconProps) {
  return (
    <SvgComponent
      color={color}
      className={className}
...
export function ShopIcon({ className, color }: IconProps) {
  return (
    <SvgComponent
      color={color}
      className={className}
...
export function ClipboardIcon({ className, color }: IconProps) {
  return (
    <SvgComponent
      color={color}
      className={className}
...
export function MenuBarsIcon({ className, color }: IconProps) {
  return (
    <SvgComponent
      color={color}
      className={className}
