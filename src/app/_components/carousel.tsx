  ...
  function Arrow(props: {
    ...
    return (
      <svg
        ...
        className={`absolute top-1/2 h-10 w-10 translate-y-1/2 cursor-pointer rounded-full border-2 border-blue-main p-3 transition-transform duration-100 ease-in-out hover:scale-110 ${props.left ? "left-2" : "left-auto right-2"}`}
      >
        {props.left ? (
  ...
  return (
    <section>
      <div className="relative">
        <div
          ref={sliderRef}
          className="keen-slider mx-auto max-w-xs md:max-w-md lg:max-w-5xl xl:max-w-6xl"
        >
          {props.children}
        </div>
