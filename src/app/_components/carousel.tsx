  ...
  function Arrow(props: {
    ...
    return (
      <svg
        ...
        className={`absolute top-1/2 h-12 w-12 translate-y-1/2 cursor-pointer rounded-full fill-blue-600 p-3 transition-transform duration-100 ease-in-out hover:scale-110 ${props.left ? "left-2" : "left-auto right-2"}`}
      >
        {props.left ? (
