...
export default function LimpezaDeEstofadosCarpetes() {
  return (
    <LandingPage
      ...
      text="Limpeza de estofados e carpetes com produtos e equipamentos de alta qualidade, que
      garantem a limpeza profunda e a remoção de manchas. Solicite um Orçamento."
    />
  );
}
